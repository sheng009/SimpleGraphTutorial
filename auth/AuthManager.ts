...
const config: AuthConfiguration = {
  ...
  serviceConfiguration: {
    authorizationEndpoint: 'https://login.microsoftonline.com/06aa9b7a-f7ae-4e01-9581-a769e9fc1bd6/oauth2/v2.0/authorize',
    tokenEndpoint: 'https://login.microsoftonline.com/06aa9b7a-f7ae-4e01-9581-a769e9fc1bd6/oauth2/v2.0/token',
  }
};
...
export class AuthManager {
  ...
  static getAccessTokenAsync = async() => {
    ...
    if (expireTime !== null) {
      ...
      console.log('now.isSameOrAfter(expire): ', now.isSameOrAfter(expire));
